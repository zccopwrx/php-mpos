...
<form method="POST">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td class="left">Disable Teams</td>
        <td class="center"><span id='tt'><img src='{$PATH}/images/questionmark.png' height='15px' width='15px' title='Enable or disable mining team support.'></span></td>
        <td>
          <select name="data[disable_teams]">
            <option value="1">Yes</option>
            <option value="0"{nocache}{if !$DISABLETEAMS} selected{/if}{/nocache}>No</option>
          </select>
        </td>
      </tr>
